        ...
        private void StartCamera()
        {
            if (CurrentDevice != null)
            {
                try
                {
                    ...
                    double ScreenRatio = System.Math.Round((double)1920 / 1080, 2);
                    ...
                    foreach (var cap in _videoSource.VideoCapabilities)
                    {
                        ...
                        double tempCamRatio = System.Math.Round((double)cap.FrameSize.Width / cap.FrameSize.Height, 2);
